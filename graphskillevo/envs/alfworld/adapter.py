"""ALFWorld environment adapter for GraphSkillEvo.

Connects the GraphSkillEvo training loop to ALFWorld by implementing
:class:`~graphskillevo.envs.base.EnvAdapter`.
"""
...
from graphskillevo.datasets.base import BatchSpec
from graphskillevo.envs.base import EnvAdapter
from graphskillevo.envs.alfworld.dataloader import ALFWorldDataLoader
from graphskillevo.envs.alfworld.paths import ensure_data_root_env
from graphskillevo.envs.alfworld.rollout import (
    build_alfworld_env,
    run_alfworld_batch,
    TASKS,
)
...
class ALFWorldAdapter(EnvAdapter):
    ...
    def setup(self, cfg: dict) -> None:
        super().setup(cfg)
        self.alfworld_data_root = ensure_data_root_env()
        cfg.setdefault("alfworld_data_root", self.alfworld_data_root)
        ...
        **kwargs,
        ...
        if isinstance(env_manager, ALFWorldBatchRun):
            ...
            results = run_alfworld_batch(
                ...
                result_ids=getattr(env_manager, "_graphskillevo_result_ids", None),
            )
