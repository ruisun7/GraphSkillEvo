...
from graphskillevo.envs.docvqa.evaluator import evaluate
from graphskillevo.model import chat_target_messages, get_target_backend, is_target_exec_backend
...
def _build_codex_skill(skill_content: str) -> str:
    return render_skill_md(
        skill_content,
        description="Dynamic GraphSkillEvo skill for solving the current DocVQA document-image question.",
        preamble=(
