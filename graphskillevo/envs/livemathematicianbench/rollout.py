...
from graphskillevo.envs.livemathematicianbench.evaluator import evaluate
from graphskillevo.model import chat_target, get_target_backend, is_target_exec_backend
...
def _build_codex_skill(skill_content: str) -> str:
    return render_skill_md(
        skill_content,
        description="Dynamic GraphSkillEvo skill for solving the current LiveMathematicianBench multiple-choice question.",
        preamble=(
