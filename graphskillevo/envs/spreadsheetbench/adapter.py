"""SpreadsheetBench environment adapter for GraphSkillEvo.

Connects the GraphSkillEvo training loop to SpreadsheetBench by implementing
...
from graphskillevo.envs.spreadsheetbench.dataloader import SpreadsheetBenchDataLoader
from graphskillevo.envs.spreadsheetbench.rollout import (
    run_spreadsheet_batch,
    run_spreadsheet_batch_codegen,
)
from graphskillevo.model import is_target_exec_backend
