"""GraphSkillEvo Model backend — Azure OpenAI wrapper with token tracking.
...
_RESPONSES_API_MODELS = {
    ...
    "gpt-5-codex", "codex-mini", "gpt-5.4-pro", "gpt-5.5",
}
...
def _make_client(role: str) -> AzureOpenAI | OpenAI:
    ...
    if auth_mode in {"openai_compatible", "compat", "openai"}:
        return OpenAI(
            ...
            default_headers={"User-Agent": "GraphSkillEvo"},
        )
