"""Generic task dataloader abstractions for GraphSkillEvo.

GraphSkillEvo does not train model parameters directly. Instead, it iterates over
...
class BaseDataLoader(ABC):
    """Abstract base class for task batch planning in GraphSkillEvo.
